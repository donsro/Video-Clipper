# Video Clipper
Hi there. Although *Video Clipper* is still pretty *bare bone* app I believe it meets basic test assignment requirements. Please note that this app was only tested in *Chrome* and *Firefox*. I hope it should also work well in *Safari*. *IE* has issues with HTML5 video fragments. My other comments can be found below in **\[ D.S. ... \]**.
